...
<body class="h-screen w-screen flex flex-col md:flex-row overflow-hidden">
  ...
  <div class="w-full md:w-1/2 h-64 md:h-full relative"
    ...
    <!-- Logo -->
    <div class="absolute bottom-6 left-6 text-white text-2xl md:text-3xl font-bold flex items-center gap-2">
      <img src="/images/turo_moko_logo_white.png" alt="Turo-Moko Logo" class="w-8 h-8 md:w-10 md:h-10 object-contain" />
  ...
  <div class="w-full md:w-1/2 flex items-center justify-center bg-white">
    <div class="w-full max-w-sm px-4 sm:px-6">
      <h2 class="text-xl md:text-2xl font-bold mb-1 text-center">Welcome back!</h2>
      ...
      <p class="text-sm text-center mt-6 text-gray-600">
        ...
        <a href="#" class="text-sm font-medium text-gray-800 hover:text-orange-500">Sign Up here.</a>
      </p>
    </div>
  </div>
</body>
