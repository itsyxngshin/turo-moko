...
>
    ...
    <div class="flex flex-col gap-8 w-full px-4">
        ...
        >
            <div class="h-10 w-10 rounded-full bg-orange-300 flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                TM
            </div>
            <span 
                x-show="expanded" 
        ...
        <div class="flex flex-col items-start w-full gap-3 mt-6">
            <a href="{{ route('learner.hub') }}" class="flex items-center gap-3 w-full px-2 py-2 rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="{{ route('learner.messages') }}" class="flex items-center gap-3 w-full px-2 py-2 rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="{{ route('learner.settings') }}" class="flex items-center gap-3 w-full px-2 py-2 rounded-lg hover:bg-gray-100 transition">
                <i data-lucide="settings" class="w-7 h-7 text-gray-600"></i>
