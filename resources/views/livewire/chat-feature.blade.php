...
<div class="flex h-screen overflow-hidden bg-gray-100 p-6 font-sans" style="font-family: 'Poppins', sans-serif;">
    
    <div class="flex w-full h-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
