<div x-data="{ open: false }" x-init="open = false" display="overflow">
    <!-- View Product Button -->
    ...
    <div x-show="open" x-cloak wire:ignore.self
        class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
            <div class="bg-white w-80% max-w-lg rounded-2xl shadow-lg p-6 relative">
                    <!-- Close Button -->
                    ...
                    <!-- Title -->
                    <h2 class="text-xl font-semibold mb-4">Manually add learner</h2>
                    <hr class="mb-4">
                    ...
                    <div class="space-y-4">
                        <!-- Course Name -->
                        <div>
                            <label class="block text-sm font-medium mb-1">Name of Learner</label>
                        ...
                        <!-- Course Name -->
                        <div>
                            <label class="block text-sm font-medium mb-1">Course to be enrolled</label>
                            <input type="text" placeholder="Choose among available courses"
                                class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-gray-200">
                        </div>
