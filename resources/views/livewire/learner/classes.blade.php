<div class="space-y-8 pl-6 w-full"> <!-- SINGLE ROOT ELEMENT -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @forelse ($activeCourses as $course)
                <div class="bg-white rounded-2xl shadow-md flex overflow-hidden border h-52">
                    <!-- Course Image -->
                    <div class="w-1/2">
                        <img src="{{ $course->cover_photo_id ? $course->cover_photo->path : '/images/course1.jpg' }}" class="w-full h-full object-cover rounded-l-2xl">
