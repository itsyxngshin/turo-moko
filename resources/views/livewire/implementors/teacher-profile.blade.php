...
<div class="p-0 ml-[20px]">
    <div class="bg-white rounded-lg border shadow-sm p-6 flex items-center gap-4">
        <img src="https://i.pravatar.cc/100" alt="Teacher Avatar" class="w-[10%] h-100 rounded-full">
    <div class="flex-1">
      <h2 class="text-lg font-semibold">Teacher name</h2>
      <p class="text-sm text-gray-500">Any description here</p>
      <p class="text-sm text-gray-400">teacher.name@example.bicol-u.edu.ph</p>
    </div>
  ...
  <div class="px-6 py-6 bg-white rounded-lg">
