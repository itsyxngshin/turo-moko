    ...
    <div class="grid grid-cols-3 gap-6 mb-8">
      <div class="bg-white rounded-lg p-6 shadow-sm border flex items-center gap-4">
        ...
        <div>
          ...
          <h2 class="text-lg font-bold">{{ $enrolleesCount ?? '--' }}</h2>
        </div>
      </div>
      <div class="bg-white rounded-lg p-6 shadow-sm border flex items-center gap-4">
       <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path stroke="black" fill="#B1CC33" d="m23.15 5.4l-2.8-2.8a.5.5 0 0 0-.7 0L7.85 14.4a.5.5 0 0 1-.7 0l-2.8-2.8a.5.5 0 0 0-.7 0l-2.8 2.8a.5.5 0 0 0 0 .7l6.3 6.3a.5.5 0 0 0 .7 0l15.3-15.3a.5.5 0 0 0 0-.7"/></svg>
        <div>
          ...
          <h2 class="text-lg font-bold">{{ $submissionsCount ?? '--' }}</h2>
        </div>
      </div>
      <div class="bg-white rounded-lg p-6 shadow-sm border flex items-center gap-4">
        ...
        <div>
          ...
          <h2 class="text-lg font-bold">{{ $evaluationsCount ?? '--     '}}</h2>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($courses as $course)
            <div class="bg-white rounded-lg shadow-md border overflow-hidden">
                <!-- Thumbnail -->
                <img src="{{ $course->thumbnail_url ?? 'https://via.placeholder.com/400x200' }}"
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4 flex justify-between items-center">
                        <a href="{{ route('implementor.course-information', ['id' => $course->id]) }}"
