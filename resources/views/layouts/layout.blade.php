...
<div x-data="{ open: false, toggleOpacity: 1 }" class="md:hidden">
    ...
    <div 
        ...
        class="fixed top-1/2 left-0 transform -translate-y-1/2 bg-white border border-gray-200 rounded-r-full shadow cursor-pointer z-[10001] flex items-center justify-center w-10 h-16 transition-opacity duration-500"
    >
